...
class Menu
{
    ...
    {
        $mpesa = new STK();
        $url   = esc_url(admin_url('admin.php?page=wc-settings&tab=checkout&section=mpesa')); ?>
        <div class="wrap">
            ...
            <article>
                ...
                <ol>
                    <li>Log in to <a href="https://org.ke.m-pesa.com/" target="_blank">M-Pesa Web Portal</a>, As the Business
                        Administrator through HO</li>
            ...
            <article>
                ...
                <ol>
                    ...
                    <li>Enter the username of a user with the Business Manager role(use the one created above if using Store
                        Number)</li>
                    <li>Click Enter and wait for the One Time Password</li>
                    <li>Enter the OTP and wait for the confirmation</li>
                    <li>Switch accounts to your newly created company and copy the app credentials displayed and paste in the <a href="<?php echo $url; ?>">plugin settings</a></li>
                    <li>If you do not receive the online passkey in your email, write to <a href="mailto:apisupport@safaricom.co.ke">apisupport@safaricom.co.ke</a> and request for the same.
                    </li>
                </ol>
                </p>
            </article>
            ...
            <article>
                ...
                <p>
                    ...
                    M-Pesa - the owner of the shortcode needs to make this request for activation. This can be done by sending
                    an
            ...
            <h3>Contact</h3>
            <h4>Incase you are unable to do this on your own, you can get in touch with us either via email (<a href="mailto:hi@osen.co.ke">hi@osen.co.ke</a>) or via phone(<a href="tel:+254705459494">+254705459494</a>)
            </h4>
