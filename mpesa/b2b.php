...
class MpesaB2C
{
  ...
  public static function request( $phone, $amount, $reference, $trxdesc, $remark )
  {
    ...
    $token      = self::token();
    $endpoint   = ( self::$env == 'live' ) ? 'https://api.safaricom.co.ke/mpesa/b2b/v1/paymentrequest' : 'https://sandbox.safaricom.co.ke/mpesa/b2b/v1/paymentrequest';
 ...
 * @return bool
 */ 
function b2b_config( $configuration = array() )
{
 ...
 * @return bool
 */ 
function b2b_validate( $callback = null, $data = null )
{
 ...
 * @return bool
 */ 
function b2b_confirm( $callback = null, $data = null  )
{
 ...
 * @return Array
 */ 
function b2b_request( $phone, $amount, $reference, $trxdesc = 'Mpesa Transaction', $remark = ' Mpesa Transaction' )
{
 ...
 * @return Bool
 */          
function b2b_reconcile( $callback = null, $data = null )
{
