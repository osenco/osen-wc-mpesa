 ...
 */
add_filter('manage_b2c_payment_posts_columns', 'filter_b2c_payments_table_columns');
 ...
 */
add_filter('manage_edit-b2c_payment_sortable_columns', 'b2c_payments_columns_sortable');
